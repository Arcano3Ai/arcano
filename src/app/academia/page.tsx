...
export const metadata: Metadata = {
  ...
  description:
    "Academia Esotérica ARCANO: Cursos profesionales de Tarot, Astrología, Numerología y Reiki. Formación paso a paso por niveles con certificación.",
  keywords: [
    "Academia esotérica",
    "Academia de Tarot",
    "Cursos de Tarot",
