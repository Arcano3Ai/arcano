...
export const academyCourses: AcademyCourse[] = [
  ...
  // ------------------------------------------------------------
  {
    ...
    level: 1,
    romanLevel: "NIVEL 1",
    title: "Tarot desde Cero — Los Primeros 12 Arcanos",
    description:
      "Iniciación profunda en los primeros 12 Arcanos Mayores (del Loco al Colgado). Incluye tratados herméticos, simbología arquetípica y sus 12 Canciones Sagradas obligatorias.",
    price: 0,
    originalPrice: 799,
    currency: "MXN",
    ...
    lessonsCount: "12 Lecciones Maestras",
    content: [
      "Arcano 0: El Loco — El Salto al Vacío y la Inocencia Sagrada",
      "Arcano I: El Mago — Como es Arriba, es Abajo y el Poder Creador",
      "Arcano II: La Sacerdotisa — El Silencio del Templo y la Memoria Oculta",
      "Arcano III: La Emperatriz — El Florecer Eterno y la Creatividad Sagrada",
      "Arcano IV: El Emperador — El Orden de la Piedra y la Estructura Terrenal",
      "Arcano V: El Hierofante — El Rito Sagrado y el Puente hacia lo Divino",
      "Arcano VI: Los Enamorados — La Sagrada Elección y la Alianza del Corazón",
      "Arcano VII: El Carro — La Victoria del Alma y la Dirección Consciente",
      "Arcano VIII: La Fuerza — La Caricia y el León: Dominio mediante el Amor",
      "Arcano IX: El Ermitaño — La Lámpara en la Cumbre y la Búsqueda Interior",
      "Arcano X: La Justicia — La Balanza Inflexible y la Ley Causa y Efecto",
      "Arcano XI: El Colgado — La Visión Invertida y la Rendición Iluminada",
    ],
    glyph: "🜁",
    cardImage: "/images/academy/Tarot_desde_Cero.jpg",
    ctaText: "VER CURSO",
    idealFor: "Iniciados que desean dominar los primeros 12 Arcanos Mayores con sus himnos sagrados obligatorios.",
    featured: true,
  },
  {
    id: "tarot-02",
