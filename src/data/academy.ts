...
export const academyCourses: AcademyCourse[] = [
  ...
  // ------------------------------------------------------------
  {
    ...
    level: 1,
    romanLevel: "NIVEL 1",
    title: "Tarot desde Cero — Fundamentos e Iniciación",
    description:
      "Iniciación profunda en el Tarot: origen histórico-hermético, anatomía de los 78 naipes, arquetipos esenciales, consagración y primeras lecturas guiadas, con la escucha obligatoria de los primeros 12 Arcanos Mayores.",
    price: 0,
    originalPrice: 799,
    currency: "MXN",
    ...
    lessonsCount: "7 Lecciones Maestras",
    content: [
      "Introducción al Tarot y su Origen Histórico-Hermético",
      "Estructura de la Baraja: Los 78 Naipes Sagrados",
      "Diferencias Esenciales: Arcanos Mayores vs. Menores",
      "Palabras Clave, Arquetipos y Glosario Iniciático",
      "Los 4 Palos y los 4 Elementos Primordiales",
      "Preparación del Espacio Sagrado, Consagración y Barajado",
      "Primeras Tiradas Guiadas: Lecturas de 1 y 3 Cartas",
    ],
    glyph: "🜁",
    cardImage: "/images/academy/Tarot_desde_Cero.jpg",
    ctaText: "VER CURSO",
    idealFor: "Iniciados que desean dominar los fundamentos sagrados del Tarot, sus 78 naipes y los primeros 12 Arcanos con sus himnos obligatorios.",
    featured: true,
  },
  {
    id: "tarot-02",
  ...
  // ------------------------------------------------------------
  {
    ...
    lessonsCount: "7 Lecciones Maestras",
    content: [
      "Qué es la Astrología: “Como es arriba, es abajo”",
      "El Mandala Zodiacal: La rueda de 360°, los 12 signos y el horizonte",
      "Las 2 Luminarias: El Sol y la Luna",
      "Los Planetas Personales: Mercurio, Venus y Marte",
      "Los 4 Elementos y las 3 Modalidades",
      "Las 12 Casas Astrológicas",
      "La Tríada Fundamental: Sol, Luna y Ascendente",
    ],
    glyph: "♈",
  ...
  // ------------------------------------------------------------
  {
    ...
    lessonsCount: "7 Lecciones Maestras",
    content: [
      "La Mística de los Números: Pitágoras y la vibración universal",
      "La Tabla Alfanumérica Pitagórica",
      "Los 9 Números Base: Vibración en luz y sombra del 1 al 9",
      "Los Números Maestros: 11, 22 y 33",
      "Deudas Kármicas: 13, 14, 16 y 19",
      "Cálculo del Sendero de Vida",
      "Tu Primer Mapa Numerológico y el Año Personal",
    ],
    glyph: "①",
  ...
  // ------------------------------------------------------------
  {
    ...
    description:
      "Iníciate en el método tradicional de Mikao Usui: canal de energía vital, los 5 principios Gokai, anatomía de los 7 chakras, técnicas Kenyoku Ho, símbolo Cho Ku Rei y autotratamiento.",
    price: 0,
    originalPrice: 799,
    currency: "MXN",
    formattedPrice: "GRATIS",
    ...
    lessonsCount: "7 Lecciones Maestras",
    content: [
      "Qué es el Reiki: El canal de la Energía Vital Universal",
      "Los 5 Principios del Reiki (Gokai)",
      "Anatomía Energética: Los 7 Chakras y el Campo Áurico",
      "Técnicas de Limpieza: Kenyoku Ho y Enraizamiento",
      "El Símbolo Cho Ku Rei",
      "Protocolo de Autotratamiento: Las 12 posiciones de manos",
      "Los 21 Días de Purificación y Ética del Terapeuta",
    ],
    glyph: "ॐ",
