 ...
 * Sirve los archivos optimizados (128kbps) directamente desde Vercel Edge con cabeceras nativas audio/mpeg,
 * garantizando reproducción instantánea en iOS Safari, Android y desktop sin trabas ni bloqueos.
 */
