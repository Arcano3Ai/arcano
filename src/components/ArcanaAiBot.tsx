  ...
  return (
    <>
      ...
      <aside
        ...
        className="fixed bottom-22 sm:bottom-24 right-6 z-40 flex items-center gap-3"
      >
      ...
      {isOpen && (
        <div
          ...
          className="fixed bottom-24 sm:bottom-28 right-3 sm:right-6 w-[94vw] sm:w-[420px] h-[590px] max-h-[82vh] rounded-2xl border border-gold/50 bg-[#0d0c15]/98 backdrop-blur-2xl shadow-[0_25px_60px_rgba(0,0,0,0.95),0_0_35px_rgba(198,160,82,0.25)] flex flex-col z-50 overflow-hidden animate-fadeIn"
        >
          {/* Cabecera */}
